...
description: Hoy en día escuchamos términos como páginas estáticas, dinámicas, SPA, multi-página y JAMStack. ¿Qué significan y por qué importa entender sus diferencias? No existe una “navaja suiza” para la web. Cada herramienta resuelve un problema particular, y conocer sus ventajas y desventajas nos ayuda a tomar mejores decisiones al crear un proyecto.
...
![Diagrama dibujado a mano. A la izquierda, un círculo con archivos pregenerados (CSS, JS, index.html y multimedia) apunta a un servidor con un web server como Apache o NGINX en los puertos 80 y 443 y la carpeta /var/www/html. Del servidor sale un “HTTP Response 200 OK” hacia un portátil con el navegador (el cliente), que a su vez envía un “HTTP Request” a la dirección pagina.com.](/images/posts/es/estatico-dinamico-spa-mpa-jamstack/diagrama-paginas-estaticas.jpg)_**Figura 1**: flujo de un sitio web estático_
...
![Diagrama dibujado a mano. A la izquierda, un círculo con varias bases de datos (“data”) apunta a un servidor con un web server en los puertos 80 y 443. Junto a él, un “App Server” con cajas de View, Routes, Lib, Static, Services y Data, escrito en PHP, Java, Python, Node.js, Ruby o C#, que genera archivos HTML. El navegador del cliente envía un GET a la dirección pagina.com y recibe la respuesta.](/images/posts/es/estatico-dinamico-spa-mpa-jamstack/diagrama-paginas-dinamicas-multipage.jpg)_**Figura 2**: flujo de un sitio web dinámico_
...
![Diagrama dibujado a mano igual al del sitio estático: archivos pregenerados, un web server en los puertos 80 y 443 y un portátil con el navegador. La diferencia es un único documento HTML con una etiqueta script y una nota que dice que siempre retorna un único documento HTML, que incluye un archivo JavaScript encargado de construir la aplicación.](/images/posts/es/estatico-dinamico-spa-mpa-jamstack/diagrama-single-page-app.jpg)_**Figura 3**: flujo de una single page app_
...
![Diagrama dibujado a mano con archivos pregenerados, un web server en los puertos 80 y 443 y el navegador del cliente intercambiando HTTP Request y HTTP Response 200 OK. Debajo del servidor, una caja con “JavaScript + APIs + Markup” apunta a una nota que dice que el contenido se genera dinámicamente en el cliente.](/images/posts/es/estatico-dinamico-spa-mpa-jamstack/diagrama-jam-stack.jpg)_**Figura 4**: flujo de un sitio web dinámico mediante JAM Stack_
